    ...
    return (
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <div className="prose dark:prose-invert">
                ...
                <h2>3. Disclaimer</h2>
                <p>The materials on EXAMSPHERE's website are provided on an 'as is' basis. EXAMSPHERE makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties.</p>
            </div>
        </div>
    );
}
